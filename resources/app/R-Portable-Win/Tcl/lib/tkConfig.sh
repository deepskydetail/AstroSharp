...
# build directory.
TK_BUILD_LIB_SPEC='-L/root/64bit/tk8.6.12/win -ltk86'
...
# compiled.
TK_SRC_DIR='/root/64bit/tk8.6.12'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/root/64bit/tk8.6.12/win -ltkstub86'
...
TK_BUILD_STUB_LIB_PATH='/root/64bit/tk8.6.12/win/libtkstub86.a'
